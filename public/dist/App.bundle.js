...
function initPulse() {
  ...
  for (var i = 0; i < pulseButtons.length; i++) {
    _loop(i);
  }
}

exports.default = initPulse;
...
function searchResultsHTML(items) {
  return items.map(function (item) {
    return '\n      <a href="/item/' + item.slug + '" class="search__result">\n        <strong>' + item.name + '</strong>\n      </a>\n    ';
  }).join('');
}
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
      ...
      searchResults.innerHTML = _dompurify2.default.sanitize('<div class="search__result">\u041D\u0438\u0447\u0435\u0433\u043E \u043D\u0435 \u043D\u0430\u0448\u043B\u043E\u0441\u044C \u043F\u043E \u0437\u0430\u043F\u0440\u043E\u0441\u0443: ' + _this.value + '</div>');
    }).catch(function (err) {
      console.error(err);
    });
  });
...
var _pulse = __webpack_require__(11);
